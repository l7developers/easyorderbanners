	...
	<div class="row">
		<div class="col-xs-12">
			<div class="box box-primary">
				<!-- /.box-header -->
				<div class="box-body">		
					{{Form::model('cat_edit',['files'=>true])}}
						<div class="col-sm-12">
							<div class="form-group row{{ $errors->has('name') ? ' has-error' : '' }}">
								<label class="col-sm-3 form-control-label">Name<span class="text-danger">*</span></label>
								<div class="col-sm-6">
									<input id="name" type="text" class="form-control" name="name" value="{{ (old('name')) ? old('name') : $category->name }}" placeholder="Category Name">
									@if ($errors->has('name'))
							...
							<div class="form-group row{{ $errors->has('slug') ? ' has-error' : '' }}">
								...
								<div class="col-sm-6">
									<input id="slug" type="text" class="form-control" name="slug" value="{{ (old('slug')) ? old('slug') : $category->slug }}" placeholder="Slug">
									@if ($errors->has('slug'))
							...
							<div class="form-group row">
								...
								<div class="col-sm-6">
									{{Form::select('parent_id',[''=>'Select Category']+$categories,(old('parent_id'))?old('parent_id'):$category->parent_id,['class'=>'form-control','id'=>'parent_id'])}}
								</div>
							</div>
							<div class="form-group row{{ $errors->has('image_title') ? ' has-error' : '' }}">
								...
								<div class="col-sm-6">
									<input id="image_title" type="text" class="form-control" name="image_title" value="{{ (old('image_title'))?old('image_title'):$category->image_title }}" placeholder="Enter Image Title" />
							...
							<div class="form-group row" id="cat_div">
								<label class="col-sm-3 form-control-label">&nbsp;</label>
								<div class="col-sm-9" id="cat_images_div">	@if(@getimagesize(url('/public/uploads/category/'.$category->image)))
									<img class="img-responsive image_list" src="{{URL::to('/public/uploads/category/'.$category->image)}}" alt="Photo">
								@endif
								</div>
							</div>
							<div class="form-group row{{ $errors->has('excerpt') ? ' has-error' : '' }}">
								...
								<div class="col-sm-8">
									<textarea id="excerpt" type="text" class="form-control" name="excerpt" placeholder="Excerpt">{{ (old('excerpt')) ? old('excerpt') : $category->excerpt }}</textarea>
							...
							<div class="form-group row{{ $errors->has('meta_title') ? ' has-error' : '' }}">
								...
								<div class="col-sm-6">
									<input id="meta_title" type="text" class="form-control" name="meta_title" value="{{ (old('meta_title'))?old('meta_title'):$category->meta_title }}" placeholder="Enter Meta Title" />
							...
							<div class="form-group row{{ $errors->has('meta_tag') ? ' has-error' : '' }}">
								...
								<div class="col-sm-6">
									<input id="meta_tag" type="text" class="form-control" name="meta_tag" value="{{ (old('meta_tag'))?old('meta_tag'):$category->meta_tag }}" placeholder="Enter Meta Keywords" />
							...
							<div class="form-group row{{ $errors->has('meta_description') ? ' has-error' : '' }}">
								...
								<div class="col-sm-6">
									<textarea id="meta_description" type="text" class="form-control" name="meta_description" placeholder="Meta Description">{{ (old('meta_description')) ? old('meta_description') : $category->meta_description }}</textarea>
							...
							<div class="form-group row">
								...
								<div class="col-sm-8 offset-sm-2">
									...
									<a href="{{url('/admin/category/lists')}}" class="btn btn-warning">Back</a>
								</div>
							</div>
						</div>
					{{Form::close()}}
