	...
	<div class="row">
		<div class="col-xs-12">
			<div class="box box-primary">
				<!-- /.box-header -->
				<div class="box-body">		
					<form role="form" method="POST" action="{{ url('admin/agents/edit/'.$id) }}">
					{{ csrf_field() }}
						<div class="col-sm-6">
							<div class="form-group row{{ $errors->has('role_id') ? ' has-error' : '' }}">
								...
								<div class="col-sm-8">
									{{Form::select('role_id',$roles,(old('role_id')) ? old('role_id') : $user->role_id,['class' => 'form-control','id' => 'role_id','placeholder' => 'Select user role'] )}}
							...
							<div class="form-group row">
								...
								<div class="col-sm-8">
								<input id="extension" type="text" class="form-control" name="extension" value="{{ (old('extension')) ? old('extension') : $user->extension }}" placeholder="Intercompany Extension">									
								</div>
							</div>
							...
							<div class="form-group row">
								...
								<div class="col-sm-8">
								<input id="direct" type="text" class="form-control" name="direct" value="{{ (old('direct')) ? old('direct') : $user->direct }}" placeholder="Direct">									
								</div>
							</div>
							...
							<div class="form-group row">
								...
								<div class="col-sm-8">
								<input id="mobile" type="text" class="form-control" name="mobile" value="{{ (old('mobile')) ? old('mobile') : $user->mobile }}" placeholder="Mobile">									
								</div>
							</div>
							...
							<div class="form-group row">
								...
								<div class="col-sm-8 offset-sm-2">
									...
									<a href="{{url('/admin/agents/lists')}}" class="btn btn-warning">Back</a>
								</div>
							</div>
						</div>
					</form>
