			...
			<div class="row invoice-info main_print_div">
				...
				@if($order->multiple_shipping == 0)
					<div class="col-md-4 col-sm-6 col-xs-12 invoice-col shipping_add_div">
						...
						<div class="col-xs-12 add_box">
							<div class="col-xs-1"><i class="fa fa-pencil-square-o address pull-right" order-id="{{$order->id}}" order-multiple="0"></i></div>
					...
					<div class="col-md-4 col-sm-6 col-xs-12 invoice-col">
						...
						@else
							<div class="col-xs-12 add_box no-padding shipping_add_{{$po_products[0]->PoProduct->item_id}}_div">
								...
								{{$po_products[0]->PoProduct->OrderPOAddress->shipping_city.', '.$po_products[0]->PoProduct->OrderPOAddress->shipping_state.', '.$po_products[0]->PoProduct->OrderPOAddress->shipping_zipcode}}
								{{$po_products[0]->PoProduct->OrderPOAddress->shipping_country}}<br/>
								</div>
							</div>
						@endif
					</div>
									...
									<td class="" style="width:25%">
										...
										<div class="col-xs-12 no-padding">
											<div class="col-xs-2 no-padding">
												<i class="fa fa-pencil-square-o options" order-id="{{$order->id}}" data-type='product_options' order-product-id="{{$val->PoProduct->id}}" order-product-name="{{$val->product_name}}"></i>
												<i class="fa fa-trash product_delete" order-id="{{$order->id}}" data-type='product_delete' order-product-id="{{$val->PoProduct->id}}" order-product-name="{{$val->product_name}}"></i>
											</div>
