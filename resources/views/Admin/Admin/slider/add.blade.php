	...
	<div class="row">
		<div class="col-xs-12">
			<div class="box box-primary">
				<!-- /.box-header -->
				<div class="box-body">
					{{Form::model('slider_add',['files'=>true,'role'=>'form','url'=>url('admin/slider/add')])}}
						<div class="col-sm-12">
							...
							<div class="form-group row hide" id="slider_view_div">
								<label class="col-sm-3 form-control-label">&nbsp;</label>
								<div class="col-sm-9" id="slider_view"></div>
							</div>
							<div class="form-group row{{ $errors->has('content_direction') ? ' has-error' : '' }}">
								...
								<div class="col-sm-6">
									{{Form::select('content_direction',[''=>'Select Content Direction','1'=>'Left','2'=>'Right'],old('content_direction'),['class'=>'form-control'])}}
