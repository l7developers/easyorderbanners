					...
					{{ csrf_field() }}
						<div class="col-sm-12">
							<div class="form-group row{{ $errors->has('company_name') ? ' has-error' : '' }}">
								...
								<div class="col-sm-6">
									<input id="company_name" class="form-control" name="company_name" value="{{ old('company_name') }}" placeholder="Company Name" >
							...
							<div class="form-group row">
								...
								<div class="col-sm-6">
									<input id="password_confirmation" type="password" class="form-control" name="password_confirmation" placeholder="Confirm Password" value="{{ old('password_confirmation') }}" required>
								</div>
							</div>
							...
							<div class="form-group row{{ $errors->has('pay_by_invoice') ? ' has-error' : '' }}">
								...
								<div class="col-sm-4" id="paid_free_div">
									{{Form::checkbox('pay_by_invoice',1,old('pay_by_invoice')?true:false,['class'=>'flat-red'])}}
								</div>
							</div>
							<div class="form-group row{{ $errors->has('tax_exempt') ? ' has-error' : '' }}">
								<label class="col-sm-3 form-control-label">Tax Exempt</label>
								<div class="col-sm-4" id="tax_exempt">
									{{Form::checkbox('tax_exempt',1,old('tax_exempt')?true:false,['class'=>'flat-red'])}}
								</div>
							</div>
							<div class="form-group row">
								...
								<div class="col-sm-9">
									<div class="row order_option_box">
										<div class="form-group col-sm-6 col-xs-12{{ $errors->has('billing_company_name') ? ' has-error' : '' }}">
											...
											{{Form::text('billing_company_name',old('billing_company_name'),['class'=>'form-control','placeholder'=>'Company Name'])}}
										...
										<div class="form-group col-sm-6 col-xs-12{{ $errors->has('billing_phone_number') ? ' has-error' : '' }}">
											{{Form::label('billing_phone_number','Phone Number',array('class'=>'form-control-label'))}} {{Form::text('billing_phone_number',old('billing_phone_number'),['class'=>'form-control','placeholder'=>'Phone Number'])}}
										...
										<div class="form-group col-sm-6 col-xs-12{{ $errors->has('billing_fname') ? ' has-error' : '' }}">
											{{Form::label('billing_fname','First Name',array('class'=>'form-control-label'))}}{{Form::text('billing_fname',old('billing_fname'),['class'=>'form-control','placeholder'=>'First Name'])}}
											@if ($errors->has('billing_fname','required'))
										...
										<div class="form-group col-sm-6 col-xs-12{{ $errors->has('billing_lname') ? ' has-error' : '' }}">
											{{Form::label('billing_lname','Last Name',array('class'=>'form-control-label'))}} {{Form::text('billing_lname',old('billing_lname'),['class'=>'form-control','placeholder'=>'Last Name'])}}
											@if ($errors->has('billing_lname','required'))
										...
										<div class="form-group col-sm-6 col-xs-12{{ $errors->has('billing_address1') ? ' has-error' : '' }}">
											{{Form::label('billing_address1','Address Line 1',array('class'=>'form-control-label'))}} {{Form::text('billing_address1',old('billing_address1'),['class'=>'form-control','placeholder'=>'Address Line 1'])}}
											@if ($errors->has('billing_address1','required'))
										...
										<div class="form-group col-sm-6 col-xs-12{{ $errors->has('billing_address2') ? ' has-error' : '' }}">
											{{Form::label('billing_address2','Address Line 2',array('class'=>'form-control-label'))}}	{{Form::text('billing_address2',old('billing_address2'),['class'=>'form-control add2','placeholder'=>'Address Line 2'])}}
											@if ($errors->has('billing_address2'))
												<span class="help-block">{{ $errors->first('billing_address2') }}</span>
											@endif
										</div>
										<div class="form-group col-sm-6 col-xs-12{{ $errors->has('billing_zipcode') ? ' has-error' : '' }}">{{Form::label('billing_zipcode','Zipcode',array('class'=>'form-control-label'))}}{{Form::number('billing_zipcode',old('billing_zipcode'),['class'=>'form-control','placeholder'=>'Zipcode'])}}
											@if ($errors->has('billing_zipcode'))
												<span class="help-block">{{ $errors->first('billing_zipcode') }}</span>
											@endif
										</div>
										<div class="form-group col-sm-6 col-xs-12{{ $errors->has('billing_city') ? ' has-error' : '' }}">									{{Form::label('billing_city','City',array('class'=>'form-control-label'))}} {{Form::text('billing_city',old('billing_city'),['class'=>'form-control','placeholder'=>'City'])}}
											@if ($errors->has('billing_city'))
												<span class="help-block">{{ $errors->first('billing_city') }}</span>
											@endif
										</div>
										<div class="form-group col-sm-6 col-xs-12{{ $errors->has('billing_state') ? ' has-error' : '' }}">	{{Form::label('billing_state','State',array('class'=>'form-control-label'))}} {{Form::select('billing_state',$states,old('billing_state'),['class'=>'form-control','placeholder'=>'State'])}}
											@if ($errors->has('billing_state'))
												<span class="help-block">{{ $errors->first('billing_state') }}</span>
											@endif
										</div>
										<div class="form-group col-sm-6 col-xs-12{{ $errors->has('billing_country') ? ' has-error' : '' }}">	{{Form::label('billing_country','Country',array('class'=>'form-control-label'))}} {{Form::text('billing_country',(old('billing_country'))?old('billing_country'):'US',['class'=>'form-control','placeholder'=>'Country','readonly'])}}
							...
							<div class="form-group row{{ $errors->has('same_as_billing') ? ' has-error' : '' }}">
								<label class="col-sm-3 form-control-label">Same As Billing Address</label>
								<div class="col-sm-4" id="paid_free_div">	{{Form::checkbox('same_as_billing',1,old('same_as_billing')?true:false,['class'=>'flat-red'])}}
								</div>
							</div>
							<div class="form-group row shipping_div">
								{{ Form::label('shipping_add', 'Shipping Address',array('class'=>'col-sm-3 form-control-label'))}}
								<div class="col-sm-9 ship_div">
									@php
									$i = 1;
									if(array_key_exists('shipping_address',old())){
									foreach(old('shipping_address') as $val){
									@endphp
									<div class="row shipping_add_box order_option_box">
										...
										<div class="form-group col-sm-6 col-xs-12">	
											<label class="form-control-label">State</label>{{Form::select('shipping_address['.$i.'][state]',$states,$val['state'],['class'=>'form-control','placeholder'=>'Select State'])}}
										</div>
										<div class="form-group col-sm-6 col-xs-12">	
											<label class="form-control-label">Country</label>
											<input class="form-control" name="shipping_address[{{$i}}][country]" value="{{(!empty($val['country']))?$val['country']:'US'}}" placeholder="Country" readonly />	
										</div>
									</div>
									@php
										$i++;
									...
									<div class="row shipping_add_box order_option_box">
										...
										<div class="form-group col-sm-6 col-xs-12">
											<label class="form-control-label">Address Line 2</label>
											<input class="form-control add2" name="shipping_address[1][add2]" value="" placeholder="Address Line 2" />
										</div>
										<div class="form-group col-sm-12 col-xs-12">
											<label class="form-control-label">Ship in care of</label>
...
<script>
<?php
if(old('same_as_billing')){
?>
	$('.shipping_div').slideUp();
	$(".shipping_div input,.shipping_div select").prop('required', false);
<?php
}
?>
...
$(document).on('ifUnchecked','[name="same_as_billing"]', function(event){
	...
	$(".shipping_div input,.shipping_div select").prop('required', true);
});
...
$(document).on('click','.add-more',function(){
	...
	str += '<div class="form-group col-sm-6 col-xs-12">	<label for="shipping_address['+_key+'][country]"="" class="form-control-label">Country</label><span class="text-danger">*</span> <input class="form-control shipping_input" placeholder="Country" name="shipping_address['+_key+'][country]" type="text" value="US" required  readonly/></div></div>';
