				...
				<div class="box-body">
					<form role="form" method="POST" enctype="multipart/form-data">
						...
						<div class="form-group row{{ $errors->has('link') ? ' has-error' : '' }}">
							...
							<div class="col-sm-6">
								<input id="link" type="text" class="form-control" name="link" value="{{old('link')}}" placeholder="Enter Link">
								@if ($errors->has('link'))
									<span class="help-block">
						...
						<div class="form-group row hide" id="customer_div">
							<label class="col-sm-2 form-control-label">&nbsp;</label>
							<div class="col-sm-6" id="logo_image_div"></div>
						</div>
						<div class="line"></div>
