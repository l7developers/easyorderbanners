...
<section class="content-header">
  <h1>Product Carousel-3 Detail</h1>
</section>
											...
											<div class="col-sm-12">
												...
												<div class="col-xs-6 col-sm-4 col-md-3" id="image_div_{{$image->id}}">
													<div class="image_main_box">
														<label for="">
															<div class="square">
																<img class="img-responsive" src="{{URL::to('/public/uploads/home/carousel3/'.$image->name)}}" alt="Photo">
															</div>
														</label>
														<label class="col-sm-8 col-xs-12 pull-left no-padding">Disp. Order : </label> &nbsp;<input type="number" name="carousel3_images[{{$image->id}}][weight]" value="{{$image->weight}}" class="col-sm-3 col-xs-12 no-padding" max="{{count($obj->images)}}" min="1"/>
														<div class="clearfix"></div>
														<label class="col-sm-5 col-xs-12 pull-left no-padding">Title : </label> &nbsp;<input type="text" name="carousel3_images[{{$image->id}}][title]" value="{{$image->title}}" class="col-sm-6 col-xs-12 no-padding"/>
														<a class="remove_media delete" href="javascript:void(0)" data-id="{{$image->id}}" data="{{$obj->title.' image'}}" data-image="public/uploads/home/carousel3/{{$image->name}}">Delete</a>
													</div>
												</div>
												@endforeach
												</div>
							...
							<div class="form-group row" id="carousel_div">
								...
								@if(!empty($sub_obj->img))
									<div class="col-sm-4 image_main_box">
										<label>
											<img class="img-responsive" src="{{URL::to('public/uploads/home/carousel3/'.$sub_obj->img)}}" alt="Photo">
										</label>
									</div>
								@endif
								</div>
