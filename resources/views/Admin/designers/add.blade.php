	...
	<div class="row">
		<div class="col-xs-12">
			<div class="box box-primary">
				<!-- /.box-header -->
				<div class="box-body">		
					<form role="form" method="POST" action="{{ url('admin/designers/add') }}">
					{{ csrf_field() }}
						<div class="col-sm-12">
							...
							<div class="form-group row{{ $errors->has('tFlow') ? ' has-error' : '' }}">
								...
								<div class="col-sm-6">
									<input id="tFlow" type="text" class="form-control" name="tFlow" value="{{ old('tFlow') }}" placeholder="tFlow Details">
									@if ($errors->has('tFlow'))
