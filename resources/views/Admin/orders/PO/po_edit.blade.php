...
<script>
	...
	$(document).on('click','.fa-trash.product_delete',function(e){		
        ...
        var custom_line_item = $(this).hasClass('custom_line_item') || product_id == 271?1:0;
	...
	$(document).on('click','.fa-pencil-square-o.address',function(e){
        ...
        var order_po_address_id = $(this).attr('order-po-address-id');
		...
		$.ajax({
			...
			type:'post',
			data:{'order_id':order_id,'order_product_id':order_product_id,'order_multiple':order_multiple, 'vendor_id':vendor_id, 'order_po_address_id': order_po_address_id},
			dataType:'json',
			beforeSend: function () {
			  $.blockUI();
			},
