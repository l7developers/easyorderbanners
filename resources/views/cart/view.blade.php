					...
					<div class="col-sm-12 col-md-12 col-lg-4">
						<div class="row">
							...
							<div class="col-xs-3">
								<div class="cart_price">
									<h5>&nbsp;</h5>
									<button type="button" class="btn btn-xs btn-success cloneProduct tooltipAdd" title="Duplicate this item" data-key="{{$key}}">
...
<div class="modal fade" id="project_comment">
