<div class="modal fade" id="customer_events">
		...
		<div class="modal-content">
			...
			<div class="modal-body">
				<div class="row events_div">
					...
					<div class="col-md-12">
						{{ Form::model('events_add', ['url' => ['admin/users/list'],'files'=>true,'id'=>'events_add']) }}
							{{ Form::hidden('event_user_id','',['id'=>'event_user_id']) }}
							{{ Form::hidden('event_customer_id','',['id'=>'event_customer_id']) }}
							<div class="col-xs-6">
...
<script>
	$(document).on('click','.events_btn',function(e){
		...
		$('#event_customer_id').val(customer_id);
		
		$.ajax({
			url:'{{url("admin/users/events")}}',
			type:'post',
