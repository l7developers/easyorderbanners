		...
		$.each(existingTokens, function(index, token) {
			if($('input[name="options[2][value]"]').length && $('input[name="options[2][value]"]').val().length){
				...
				if($('#price_sqft_area').is(':checked')){
					...
					str += '<td><div class="form-group"><input type="text" name="variant_option_price[1][price_300]" value="'+price_300+'" class="form-control" placeholder="Enter Price" required /></div></td>';
					str += '<td><div class="form-group"><input type="text" name="variant_option_price[1][price_500]" value="'+price_500+'" class="form-control" placeholder="Enter Price" required /></div></td>';
					str += '<td><div class="form-group"><input type="text" name="variant_option_price[1][price_1000]" value="'+price_1000+'" class="form-control" placeholder="Enter Price" required /></div></td>';
				}
				str += '</tr>'; 
			}
		});
